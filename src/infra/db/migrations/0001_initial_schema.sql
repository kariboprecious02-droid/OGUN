...
CREATE TABLE IF NOT EXISTS merchant_settings (
    id                         varchar(40) PRIMARY KEY,
    merchant_id                varchar(40) NOT NULL REFERENCES merchants(id) ON DELETE CASCADE,
    sub_merchant_id            varchar(40) REFERENCES sub_merchants(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS merchant_feedback_requests (
    id                         varchar(40) PRIMARY KEY,
    merchant_id                varchar(40) NOT NULL REFERENCES merchants(id) ON DELETE CASCADE,
    compliance_review_id       varchar(40) REFERENCES compliance_reviews(id),
...
CREATE TABLE IF NOT EXISTS collections (
    ...
    settlement_batch_id        varchar(40),
    metadata                   jsonb,
    idempotency_key            varchar(120) UNIQUE,
...
CREATE TABLE IF NOT EXISTS collection_audit_events (
    id                         varchar(40) PRIMARY KEY,
    collection_id              varchar(40) NOT NULL REFERENCES collections(id) ON DELETE CASCADE,
    event_source               varchar(20) NOT NULL,
    event_type                 varchar(50) NOT NULL,
    previous_internal_status   varchar(40),
    new_internal_status        varchar(40),
...
CREATE TABLE IF NOT EXISTS beneficiaries (
    ...
    provider_recipient_type    varchar(40),
...
CREATE TABLE IF NOT EXISTS payouts (
    ...
    merchant_id                varchar(40) NOT NULL REFERENCES merchants(id) ON DELETE CASCADE,
    sub_merchant_id            varchar(40) NOT NULL REFERENCES sub_merchants(id) ON DELETE CASCADE,
    beneficiary_id             varchar(40) NOT NULL REFERENCES beneficiaries(id),
    amount                     bigint NOT NULL,
    fee_amount                 bigint NOT NULL DEFAULT 0,
    ...
    internal_method            varchar(40) NOT NULL,
...
CREATE TABLE IF NOT EXISTS settlements (
    ...
    payout_id                  varchar(40) REFERENCES payouts(id),
...
CREATE TABLE IF NOT EXISTS settlement_line_items (
    id                         varchar(40) PRIMARY KEY,
    settlement_id              varchar(40) NOT NULL REFERENCES settlements(id) ON DELETE CASCADE,
    reference_type             varchar(40) NOT NULL,
    reference_id               varchar(40) NOT NULL,
    amount                     bigint NOT NULL,
    direction                  varchar(10) NOT NULL CHECK (direction IN ('credit','debit')),
...
CREATE TABLE IF NOT EXISTS webhook_deliveries (
    id                         varchar(40) PRIMARY KEY,
    merchant_id                varchar(40) NOT NULL REFERENCES merchants(id) ON DELETE CASCADE,
    webhook_endpoint_id        varchar(40) REFERENCES webhook_endpoints(id),
