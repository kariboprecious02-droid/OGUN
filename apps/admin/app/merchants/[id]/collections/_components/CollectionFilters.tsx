...
const METHODS = ['mpesa', 'airtel', 'card'] as const;
...
export function CollectionFilters({
  ...
  const hasFilters = currentStatus || currentMethod || currentFrom || currentTo || currentSearch;
  ...
  return (
    <div className="panel-padded mb-4 space-y-3">
      ...
      <div className="flex flex-wrap items-end gap-3">
        ...
        <div>
          <label className="text-xs text-ogun-muted block mb-1">Search</label>
          <input
            type="text"
            value={search}
            ...
            placeholder="Collection ID or phone…"
            className="text-xs bg-ogun-bg border border-ogun-border rounded px-2 py-1 text-ogun-text w-[180px]"
          />
        </div>
